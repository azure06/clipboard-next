use clipboard_next::{Clipboard, ClipboardContent, ClipboardContext, ContentFormat};
...
fn get_files() -> Vec<String> {
	let test_file1 = format!("{}clipboard_next_test_file1.txt", TMP_PATH);
	let test_file2 = format!("{}clipboard_next_test_file2.txt", TMP_PATH);
